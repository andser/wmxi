...
#		$req->reqn = $reqn;
    ...
    if ($this->classic) {
      ...
      $req->sign = $this->_sign($this->wmid.strlen($name).$ctype); # can be error due multibyte strings by default
    }
...
#		$req->secret_key = $secret_key;
  ...
  public function X19($type, $direction, $pursetype, $amount, $wmid, $pnomer, $fname, $iname, $bank_name, $bank_account, $card_number, $emoney_name, $emoney_id) {
    ...
    $url = $this->classic ? 'https://apipassport.webmoney.ru/XMLCheckUser.aspx' : 'https://apipassportcrt.webmoney.ru/XMLCheckUserCert.aspx';
